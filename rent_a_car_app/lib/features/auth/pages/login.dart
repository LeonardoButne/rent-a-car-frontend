    ...
    try {
      ...
      if (data != null && data['otp_required'] == true) {
        ...
        final snackBar = SnackBar(
          content: Text('Seu e-mail precisa ser confirmado. Verifique sua caixa de entrada.'),
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) => OTPVerificationScreen(
              ...
              deviceId: fcmToken,
              isLoginOtp: true,
              // Adicionar parâmetro opcional para mensagem
              infoMessage: 'Seu e-mail precisa ser confirmado. Verifique sua caixa de entrada.',
            ),
          ),
        );
      } else {
            ...
            child: IntrinsicHeight(
              child: Column(
                ...
                children: [
                  ...
                  // Botão de Reenviar código de verificação
                  SizedBox(
                    width: double.infinity,
                    height: 48,
                      ...
                      onPressed: _isLoading ? null : () async {
                        ...
                        final result = await showDialog<String>(
                          ...
                          builder: (context) => AlertDialog(
                            title: Text('Reenviar código de verificação'),
                            content: TextField(
                        ...
                        if (result != null && result.isNotEmpty) {
                          ...
                          try {
                            ...
                            if (response.statusCode == 200) {
                              final snackBar = SnackBar(
                                content: Text('Código reenviado para $result'),
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => OTPVerificationScreen(
                                    email: result,
                                    isLoginOtp: true,
                                    infoMessage: 'Digite o código enviado para seu e-mail.',
                                  ),
                                ),
                              );
                            } else {
